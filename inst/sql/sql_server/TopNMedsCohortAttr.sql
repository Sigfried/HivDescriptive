...
{@block_to_run == 'top drug ids'} ? {
  ...
  INNER JOIN @cdm_database_schema.drug_exposure de ON de.person_id = c.@row_id_field
  WHERE c.cohort_start_date <= de.drug_exposure_start_date AND
        c.cohort_end_date >= de.drug_exposure_start_date
